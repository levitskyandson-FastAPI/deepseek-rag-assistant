...
- Если изменения есть, внутри тегов укажи только изменяемые поля (например, {{"preferred_date": "04.03.2026 14:00"}}).
...
- Клиент: «перенеси на послезавтра» → JSON: {{"preferred_date": "04.03.2026 14:00"}}, текст: «Хорошо, изменил дату».
