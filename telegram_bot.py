...
Когда пользователь предлагает время для созвона, всегда проси указать точное время в формате ЧЧ:ММ (например, 15:30). Если он говорит "завтра в 14:00" — это хорошо. Если говорит "завтра после обеда", "вечером", "утром", "в обед" и т.п. — уточни: "Во сколько именно вам удобно? Назовите, пожалуйста, точное время." Не принимай такие ответы как окончательные. Обновляй поле preferred_date только после получения конкретного времени.
